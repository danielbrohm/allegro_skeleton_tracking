/*
This ROS-node (state_publisher_simulation) publishes joint positions for an Allegro hand simulation on RVIZ (right hand). 
...
Calculated joint angles, based on the monitored joint positions, are sent to the Allegro hand simulation. 
...
int main(int argc, char** argv) {
    ros::init(argc, argv, "state_publisher_simulation");
    ros::NodeHandle n;
